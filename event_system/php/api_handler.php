...
if (!$stmt->execute()) {
    ...
    // --------------------------------------------
    $subject = "Welcome to Event Attendance Management System";

    $body = "Hello {$name},\n\n".
            "Congratulations! You have been successfully registered in the Event Attendance Management System (EAMS).\n\n".
            "Here are your login credentials:\n".
            "Email: {$email}\n".
            "Password: password123\n\n".
            "Your Registration ID: {$reg_id}\n\n".
            "You may now log in and access your dashboard.\n\n".
            "If you did not perform this registration, please ignore this message.\n\n".
            "Best regards,\n".
            "Event Attendance Management System Team";
    ...
    sendEmail("lomopog.clark777@gmail.com", $subject, $body);

    jsonResponse(true, "Feedback sent successfully!");
    break;

    case 'download_backup':

    header("Content-Type: text/csv");
    header("Content-Disposition: attachment; filename=system_backup_" . date('Y-m-d_H-i-s') . ".csv");

    $tables = ['users', 'events', 'attendance', 'audit_logs', 'participants'];
